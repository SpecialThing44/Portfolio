      ...
      <div className={`${backgroundColor} overflow-hidden`}>
        ...
        >
          <div className="text-centermax-w-2xl mx-auto  mt-32">
            ...
            {
              <div
                className={`${backgroundColor} animate-bounce mt-32 ml-12 p-2 w-10 h-10 ring-2 ${
                  theme === "light" ? "ring-gray-800" : "ring-slate-200/20"
        ...
        <div
          className={`${backgroundColor} min-h-full flex justify-center font-mono`}
        >
          <div
            className={`${boxColor} w-3/4 p-8 mt-16 mb-12 mx-auto ${textColor} overflow-y-auto`}
          >
            ...
            <p className="text-lg">
              <p className="text-lg">
                ...
                <br />
                <br />
                <span className="font-bold">Software Engineering:</span> I'm a
                fullstack developer, primarily interested in work with backend
                architecture and databases, shipping real-world, useful
                applications to clients.
                <br />
                <br />
                <span className="font-bold">Machine Learning:</span> I'm
                interested in the applications of machine learning to various
                fields, and have worked as a researcher in the field of
                ...
                musician, and have played the piano for 16 years. I play the
                drums, and a bit of guitar and clarinet. I spend much of my time
                listening to, playing, and writing music. I love exploring new
                genres and styles and feel lucky to have music as a regular part
                of my life.
                <br />
                <br />
                <span className="font-bold">Cooking:</span> I love to cook, both
                for myself and others. I love sharing the results of my work,
                and I'm currently working on a recipe website as a side project.
              </p>
            </p>
          </div>
        </div>
        <div
          className={`${backgroundColor} ${textColor} w-3/4 mx-auto mb-5 font-mono `}
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div
              ref={scrollContainer}
              className="flex justify-between items-center overflow-x-auto whitespace-normal w-min"
            >
              {displayedEvents.map((event, index) => (
                <div
                  key={index}
                  className="text-center flex flex-col items-center w-40 m-5"
                >
                  <h2 className="text-center animate-hover">{event.year}</h2>
                  <p className="text-center h-12 w-40">{event.event}</p>
                  {event.label === "school" && (
                    <FaSchool className="mt-2 mb-2" />
                  )}
                  {event.label === "city" && <FaCity className="mt-2 mb-2" />}
                  {event.label === "graduation" && (
                    <FaGraduationCap className="mt-2 mb-2" />
                  )}
                  {event.label === "university" && (
                    <FaSchool className="mt-2 mb-2" />
                  )}
                  {event.label === "lab" && <ImLab className="mt-2 mb-2" />}
                  {event.label === "research" && (
                    <GiArchiveResearch className="mt-2 mb-2" />
                  )}
                </div>
              ))}
            </div>
